...
import { changePassword } from "../../Services/changePassword";  // Подключаем асинхронный экшен
import "./PasswordForm.scss";

const PasswordForm = () => {
  const dispatch = useDispatch();
  const [isSubmitting, setIsSubmitting] = useState(false);  // Контролируем отправку формы

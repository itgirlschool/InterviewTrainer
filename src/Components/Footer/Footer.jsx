...
export default function Footer() {
    return (
        <footer className="footer">
            <button className="footer__button">
                <NavLink target="_blank" to="https://itgirlschool.com/">
                    <img
                        ...
                        src={img_google}
                        alt="Перейти на страницу ITGIRLS"
                    />
                </NavLink>
            </button>
            <button className="footer__button">
                <NavLink target="_blank" to="https://www.instagram.com/itgirlschool/">
                    <img
                        className="footer__img"
                        src={img_insta}
                        alt="Перейти в инстаграмм ITGIRLS"
                    />
                </NavLink>
            </button>
            <button className="footer__button">
                <NavLink
                    target="_blank"
                    to="https://api.whatsapp.com/send/?phone=79965221233&text&type=phone_number&app_absent=0"
                >
                    <img
                        className="footer__img"
                        src={img_whatsapp}
            ...
            <button className="footer__button">
                <NavLink target="_blank" to="https://www.facebook.com/itgirlschool">
                    <img
                        className="footer__img"
                        src={img_facebook}
            ...
            <button className="footer__button">
                <NavLink target="_blank" to="https://t.me/itgirlschool">
                    <img
                        className="footer__img"
                        src={img_telegram}
